...
<Meta title="Components/UI/Buttons" component={Button} />
  ...
  >
    {() => {
      return {
        components: { Button },
        template: `
          <Button is="a" href="#" role="button">Link</Button>
          <Button type="submit">Button[type=submit]</Button>
          <Button is="input" type="button" value="Input[type=button]" />
          <Button is="input" type="button" value="Input[type=submit]" />
        `,
      };
    }}
  </Story>
...
<Canvas withSource="open">
  ...
  >
    {() => {
      return {
        components: { Button },
        template: buttonSizes.map(size=>`<Button size="${size}">${size}</Button>`).join(""),
      };
    }}
  </Story>
</Canvas>
  ...
  <Story name="BlockSizes">
    {() => {
      return {
        components: { Button },
        template: `
          <Button type="button" isBlock>Default</Button>
          <Button type="button" variant="primary" isBlock>Primary</Button>
        `,
      };
    }}
  </Story>
